...
df = "/work/10579/prisha/ls6/desi_project/reconstructions/39627553509475403/20210517/recon_39627553509475403_20210517.fits"


with fits.open(df) as hdul:
    hdul.info()          # shows all HDUs and their structure
    header = hdul[0].header   # try index 0 first
    print(repr(header))
